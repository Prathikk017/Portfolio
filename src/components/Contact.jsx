...
const Contact = () => {
  return (
    <div id='contact' className='max-w-[1040px] m-auto h-screen md:pl-19 p-4 py-16'>
        ...
        <form action="" method='POST' encType='multipart/form-data'>
            ...
            <div className='flex flex-col py-2'>
                ...
                <textarea className='border-2 rounded-lg p-2 border-gray-300 hover:border-[#0437b8] duration-200' rows='6' name='message' ></textarea>
            </div>
